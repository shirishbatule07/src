export class DattaConfig {
  public static config = {
    ...
    'pre-layout': 'layout-2,', // null, layout-2, layout-2-2, layout-3, layout-4, layout-4-2, layout-6, layout-8
    'collapse-menu': true,
    ...
    'nav-back-color': 'navbar-blue', // navbar-default, navbar-blue, navbar-red, navbar-purple, navbar-lightblue, navbar-dark
